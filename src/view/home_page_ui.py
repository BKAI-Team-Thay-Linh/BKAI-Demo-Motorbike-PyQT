...
class Ui_HomePage(object):
    def setupUi(self, HomePage):
        ...
        self.process_button.setGeometry(QtCore.QRect(230, 590, 101, 41))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
...
"                            74);color:white;font-weight:600}")
        ...
        self.conf_slide.setGeometry(QtCore.QRect(220, 310, 261, 16))
        ...
        self._label.setGeometry(QtCore.QRect(60, 296, 141, 41))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setItalic(False)
        ...
        self.opt_light_enhance.setGeometry(QtCore.QRect(60, 520, 161, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.opt_light_enhance.setFont(font)
        self.opt_light_enhance.setObjectName("opt_light_enhance")
        self.label_2 = QtWidgets.QLabel(parent=self.frame)
        self.label_2.setGeometry(QtCore.QRect(60, 480, 91, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.opt_fog_dehaze.setGeometry(QtCore.QRect(340, 520, 131, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.yolo_combobox.setGeometry(QtCore.QRect(220, 260, 261, 25))
        self.yolo_combobox.setObjectName("yolo_combobox")
        self.device_label_3 = QtWidgets.QLabel(parent=self.frame)
        self.device_label_3.setGeometry(QtCore.QRect(60, 340, 151, 41))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setItalic(False)
        ...
        self.classify_combobox.setGeometry(QtCore.QRect(220, 350, 261, 25))
        self.classify_combobox.setObjectName("classify_combobox")
        self.tracking_combobox = QtWidgets.QComboBox(parent=self.frame)
        self.tracking_combobox.setGeometry(QtCore.QRect(220, 400, 261, 25))
        self.tracking_combobox.setObjectName("tracking_combobox")
        self.device_label_4 = QtWidgets.QLabel(parent=self.frame)
        self.device_label_4.setGeometry(QtCore.QRect(60, 390, 151, 41))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setItalic(False)
        self.device_label_4.setFont(font)
        self.device_label_4.setObjectName("device_label_4")
        self.save_video_button = QtWidgets.QPushButton(parent=self.frame)
        self.save_video_button.setGeometry(QtCore.QRect(980, 710, 75, 24))
...
"                            <html><head/><body><p><br/></p></body></html>"))
        ...
        self.play_video_button.setText(_translate("HomePage", "Play / Pause"))
        self.device_label_2.setText(_translate("HomePage", "YOLO model:"))
        self.device_label_3.setText(_translate("HomePage", "Classification model:"))
        self.device_label_4.setText(_translate("HomePage", "Tracking model:"))
